...
def test_etl(mocker, monkeypatch):
    ...
    mocker.patch('azure.storage.blob.BlobClient.from_connection_string', return_value=mock_client)
    etl()
    BlobClient.from_connection_string.assert_called_with(conn_str="conn_string",
                                                         container_name='nope',
